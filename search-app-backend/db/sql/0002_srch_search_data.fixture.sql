insert into search_data (hash, title, content)
values ('hash-1',
...
insert into search_data (hash, title, content)
values ('hash-2',
        to_tsvector('english', 'Metadata History'),
...
insert into search_data (hash, title, content)
values ('hash-3',
        to_tsvector('english', 'Metadata Definition'),
...
insert into search_data (hash, title, content)
values ('hash-4',
        to_tsvector('english', 'Metadata Types'),
...
insert into search_data (hash, title, content)
values ('hash-5',
        to_tsvector('english', 'Metadata Structures'),
